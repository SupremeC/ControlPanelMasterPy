...
class Hwctrl:
    ...
    def set_state_of_leds(self, new_state:bool, onlyfollow: bool = False) -> List[Packet]:
...
class HwCtrls:
    ...
    def _list_ledstripr_controls(self):
        ...
        lsr_pwr.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=5,
                    led_on_val=PWM_MAX, led_follow_state=False))
        lsr_pwr.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=8, led_on_val=PWM_MAX))
        lsr_preveffect = Hwctrl(pin=33, section="ledstripR", name="RightLedStripPreEffectBtn")
        lsr_preveffect.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=6,
                    led_on_val=PWM_MAX, led_follow_state=False))
        lsr_nexteffect = Hwctrl(pin=34, section="ledstripR", name="RightLedStripNextEffectBtn")
        lsr_nexteffect.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=7,
                    led_on_val=PWM_MAX, led_follow_state=False))
    ...
    def _list_ledstripl_controls(self):
        ...
        lsl_pwr.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=1,
                    led_on_val=PWM_MAX, led_follow_state=False))
        lsl_pwr.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=4, led_on_val=PWM_MAX))
        lsl_preveffect = Hwctrl(pin=36, section="ledstripL", name="LeftLedStripPreEffectBtn")
        lsl_preveffect.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=2,
                    led_on_val=PWM_MAX, led_follow_state=False))
        lsl_nexteffect = Hwctrl(pin=37, section="ledstripL", name="LeftLedStripNextEffectBtn")
        lsl_nexteffect.leds.append(
            LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=3,
                    led_on_val=PWM_MAX, led_follow_state=False))
    ...
    def _list_aux_controls(self):
        ...
        aux_lampbtn.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=12, led_on_val=PWM_MAX))
    ...
    def _list_waveformcollider_controls(self):
        ...
        wf_speaker.leds.append(LEDCtrl(ledboard=PwmBoard.I2CBLED, led_pin=12, led_on_val=PWM_MAX))
        wf_speaker.leds.append(LEDCtrl(ledboard=PwmBoard.I2CBLED, led_pin=13, led_on_val=PWM_MAX))
        wf_speaker.leds.append(LEDCtrl(ledboard=PwmBoard.I2CBLED, led_pin=14, led_on_val=PWM_MAX))
        wf_speaker.leds.append(LEDCtrl(ledboard=PwmBoard.I2CBLED, led_pin=15, led_on_val=PWM_MAX))
        wf_volumectrl = Analogctrl(pin=109, section="waveform", name="volumectrl")  # Volume ctrl
        wf_rec = Hwctrl(pin=27, section="waveform", name="recordbtn")
        wf_rec.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=0, led_on_val=PWM_MAX))
    ...
    def _list_subspacesat_controls(self):
        for i in range(0,6):  #including 0, not including 6
            ...
            sscbtn.leds.append(LEDCtrl(ledboard=PwmBoard.I2CALED, led_pin=i, led_on_val=PWM_MAX))
        ...
        for i in range(0,4):  #including 0, not including 4
            ...
            sscflip.leds.append(LEDCtrl(ledboard=PwmBoard.I2CBLED, led_pin=i, led_on_val=PWM_MAX))

            sscbtn = Hwctrl(pin=i+8, section="subspace", name=f"sccbtn{i+7}")
            sscbtn.leds.append(LEDCtrl(ledboard=PwmBoard.I2CALED, led_pin=i+6, led_on_val=PWM_MAX))
            self.ctrls.extend([sscflip, sscbtn])
    ...
    def _list_master_controls(self):
        ...
        ma_backl.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=13, led_on_val=PWM_MAX))
        ...
        ma_inputsw.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=14, led_on_val=PWM_MAX))

        ma_soundsw = Hwctrl(pin=16, name="SoundSw", section="master")
        ma_soundsw.leds.append(LEDCtrl(ledboard=PwmBoard.I2CCLED, led_pin=15, led_on_val=PWM_MAX))
